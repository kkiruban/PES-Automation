...
Then(/^I should see "([^"]*)" field with read and write permission for Ops Manager Ops Rep and Sales Manager$/) do |value|
  if (ENV['UserRole'] == "OperationManagerSit") || (ENV['UserRole'] == "OperationRepSit") || (ENV['UserRole'] == "SalesManagerSit") || (ENV['UserRole'] == "OperationManagerProd")  ||  (ENV['UserRole'] == "OperationManagerSit") || (ENV['UserRole'] == "OperationRepSit") || (ENV['UserRole'] == "SalesManagerSit") || (ENV['UserRole'] == "OperationManagerProd") || (ENV['UserRole'] == "OperationRepProd") || (ENV['UserRole'] == "SalesManagerProd")
